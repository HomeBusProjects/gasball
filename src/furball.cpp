...
SensirionUartSfa3x h2co_sensor;

HardwareSerial h2co_serial = Serial1; // formaldehyde
...
void furball_setup() {
  ...
  h2co_serial.begin(115200, SERIAL_8N1, 14, 21);
...
static bool furball_co2_update(char* buf, size_t buf_len) {
  ...
  snprintf(buf,
	   buf_len,
	   "{  \"co2\": %.0f, \"--temperature\": %3.1f, \"--humidity\": %4.0f, \"--source\": \"SCD4x\" }",
...
static bool furball_h2co_update(char* buf, size_t buf_len) {
  ...
  uint16_t result = h2co_sensor.readMeasuredValuesOutputFormat2(h2co_value,
								humidity,
								temperature);
  ...
  snprintf(buf,
	   buf_len,
	   "{  \"h2co\": %0.1f, \"--temperature\": %0.1f, \"--humidity\": %0.0f, \"source\": \"Sensirion SFA30\" }",
...
static bool furball_no2_update(char* buf, size_t buf_len) {
  ...
  snprintf(buf,
	   buf_len,
	   "{  \"no2\": %0.4f, \"--temperature\": %0.1f, \"--source\": \"DFRobot NO2\" }",
...
static bool furball_o3_update(char* buf, size_t buf_len) {
  ...
  snprintf(buf,
	   buf_len,
	   "{  \"o3\": %0.4f, \"--temperature\": %0.1f, \"--source\": \"DFRobot O3\" }",
...
static bool furball_co_update(char* buf, size_t buf_len) {
  ...
  snprintf(buf,
	   buf_len,
	   "{  \"co\": %0.4f, \"--temperature\": %0.1f, \"--source\": \"DFRobot CO\" }",
...
static bool furball_h2s_update(char* buf, size_t buf_len) {
  ...
  snprintf(buf,
	   buf_len,
	   "{  \"h2s\": %0.4f, \"--temperature\": %0.1f, \"--source\": \"DFRobot H2S\" }",
...
static bool furball_nh3_update(char* buf, size_t buf_len) {
  ...
  snprintf(buf,
	   buf_len,
	   "{  \"nh3\": %0.4f, \"--temperature\": %0.1f, \"--source\": \"DFRobot NH3\" }",
