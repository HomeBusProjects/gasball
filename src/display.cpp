...
static void (*screen_handlers[])() = {
    display_screen_message,      display_screen_time,         display_screen_temperature,  display_screen_temperature_f,
    display_screen_humidity,     display_screen_pressure,     display_screen_voc,          display_screen_pm1,
    display_screen_pm2_5,        display_screen_pm10,         display_screen_lux,          display_screen_infrared,
    display_screen_ip_address,   display_screen_all_air,      display_screen_all_air_f,    display_screen_all_light,
    display_screen_all_particle, display_screen_all_off,      display_screen_all_on,       display_screen_aqi,
    display_screen_poop,         display_screen_user_bitmap1, display_screen_user_bitmap2, display_screen_user_bitmap3,
    display_screen_rbg,
};
